...
from widgets.audit_risk_assessment.streamlit2 import render  # existing renderer

# ====== Config (match Home/Application) ======
PAGE_TITLE = "Audit Risk Assistant"
PAGE_ICON = "🔍"
APP_LAYOUT = "wide"
...
TOOLS: Dict[str, str] = {
    ...
    "Audit Assistant": "pages/4_RAG_Audit_Assistant.py",  # <-- this page
...
# ====== Styling (same as Home/Application) ======
def inject_css() -> None:
    st.markdown(
        """
        <style>
...
with st.sidebar:
    ...
    selected_tool = st.selectbox(
        ...
        key="__tool_search_sidebar_rag__",
    )
    if selected_tool:
