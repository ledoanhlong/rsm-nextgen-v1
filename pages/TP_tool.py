...
from widgets.Tp_tool_clean.streamlit_app import render  # your existing tool

# ====== Config (match Home/Application) ======
PAGE_TITLE = "TP Local File Agent"
PAGE_ICON  = "📄"
APP_LAYOUT = "wide"
...
TOOLS: Dict[str, str] = {
    ...
    "Audit Assistant": "pages/4_RAG_Audit_Assistant.py",
    "Transfer Pricing Tool": "pages/3_TP_Template_Filler.py",  # <-- this page
...
with st.sidebar:
    ...
    selected_tool = st.selectbox(
        ...
        key="__tool_search_sidebar_tp__",
    )
    if selected_tool:
    ...
    # Soft logout (same approach as other pages)
