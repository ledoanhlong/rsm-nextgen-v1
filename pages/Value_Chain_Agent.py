...
from widgets.Value_Chain_Analysis.streamlit2 import render  # your existing renderer

# ====== Config (match Home/Application) ======
PAGE_TITLE = "Value Chain Analysis Agent"
APP_LAYOUT = "wide"
PAGE_ICON = "🔺"
...
with st.sidebar:
    ...
    selected_tool = st.selectbox(
        ...
        key="__tool_search_sidebar_vca__",
    )
    if selected_tool:
...
# Your existing embedded app (render() injects its own CSS as needed)
render(
